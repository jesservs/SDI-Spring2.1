  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="myModalLabel">Sistema de Gerenciamento de Incidente</h4>
      </div>
      <form role="form" action="logar">
	      <div class="modal-body" data-form="logar">
			  <div class="form-group">
			    <label>Login</label>
			    <input type="text" class="form-control" name="login" placeholder="Login" data-required>
			  </div>
			  <div class="form-group">
			    <label>Senha</label>
