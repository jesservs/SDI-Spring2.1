...
function listarCategoria(numPagina){
	$.ajax({
        url: '/SDI-Spring2.1/categoria/findAllJSON',
        data: {
        	pagina: numPagina,
        },
...
function carregarTipoPrioridades(){
	$.ajax({
        url: '/SDI-Spring2.1/categoria/findAllTipoAndPrioridadeJSON',
        success: function (data) {
...
function obterNumeroElementos(){
	$.ajax({
        url: '/SDI-Spring2.1/categoria/getNumberElementos',
        success: function (data) {
...
function createUpdateCategoria(){
	...
	var url = '/SDI-Spring2.1/categoria/create';
	
	if(id != undefined && id != "") url = '/SDI-Spring2.1/categoria/update';
...
function deleteCategoria(id){
	$.ajax({
        url: '/SDI-Spring2.1/categoria/delete',
        data: {
        	idCategoria: id
        },
        success: function (data) {
