...
function listarConhecimento(){
	$.ajax({
        url: '/SDI-Spring2.1/conhecimento/findAllJSON',
...
function listarConhecimentoComFiltro(){
	if(validarCampos('conhecimentoFiltro')){
		...
		$.ajax({
	        url: '/SDI-Spring2.1/conhecimento/findAllJSONComFiltro',
	        data: {
...
function createUpdateConhecimento(){
	...
	var url = '/SDI-Spring2.1/conhecimento/create';
...
function deleteConhecimento(id){
	$.ajax({
        url: '/SDI-Spring2.1/conhecimento/delete',
        data: {
        	idConhecimento: id
        },
        success: function (data) {
