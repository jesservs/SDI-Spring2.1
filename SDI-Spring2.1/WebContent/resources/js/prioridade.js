...
function deletePrioridade(id){
	$.ajax({
        url: '/SDI-Spring2.1/prioridade/delete',
        data: {
        	idPrioridade: id
        },
        success: function (data) {
...
function preencherFormAlterarPrioridade(id){
	$.ajax({
        url: '/SDI-Spring2.1/prioridade/findByCodeJSON',
        data: {
        	idPrioridade: id
        },
        success: function (data) {
...
function createUpdatePrioridade(){
	...
	var url = '/SDI-Spring2.1/prioridade/create';
	
	if(id != undefined && id != "") url = '/SDI-Spring2.1/prioridade/update';
