...
function createQualidade(){
	...
	var url = '/SDI-Spring2.1/qualidade/create';
...
function setTecnico(){
	...
	var url = '/SDI-Spring2.1/chamado/setResponsavel';
...
function setStatus(){
	...
	var url = '/SDI-Spring2.1/chamado/setNovoStatus';
...
function create(){
	...
	var url = '/SDI-Spring2.1/chamado/create';
...
function listarPrioridade(){
	$.ajax({
        url: '/SDI-Spring2.1/prioridade/findAllJSON',
        success: function (data) {
...
function listarTodosChamados(numPagina){
	$.ajax({
        url: '/SDI-Spring2.1/chamado/findAll',
        data: {
        	pagina: numPagina,
        },
        success: function (data) {
...
function listarTodosChamadosFiltro(numPagina){
	...
	$.ajax({
        url: '/SDI-Spring2.1/chamado/findAllComFiltro',
        data: {
        	pagina: numPagina,
        	'status.idStatus': idStatus,
...
function obterNumeroElementosComFiltro(){
	...
	var idPrioridade = $("[data-select-filtro='prioridade']").val();
	$.ajax({
        url: '/SDI-Spring2.1/chamado/getNumberElementosComFiltro',
        data: {
        	'status.idStatus': idStatus,
        	'categoria.prioridade.idPrioridade': idPrioridade
        },
...
function obterNumeroElementos(){
	$.ajax({
        url: '/SDI-Spring2.1/chamado/getNumberElementos',
        success: function (data) {
        	if(data > 10) 
...
function listarUsuario(){
	$.ajax({
        url: '/SDI-Spring2.1/usuario/findAllByPerfilJSON',
        success: function (data) {
...
function listarTecnicos(){
	$.ajax({
        url: '/SDI-Spring2.1/usuario/findTecnicosJSON',
        success: function (data) {
...
function listarCategoria(codTipo){
	...
	$.ajax({
        url: '/SDI-Spring2.1/categoria/findAllByTipoJSON',
        data: {
        	codTipo: codTipo
        },
        success: function (data) {
