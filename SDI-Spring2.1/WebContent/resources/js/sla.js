...
function verificarGrafico(){
	$.ajax({
        url: '/SDI-Spring2.1/sla/carregarGraficoSLA',
...
function listarAtendentes(){
	$.ajax({
        url: '/SDI-Spring2.1/usuario/findAtendentesJSON',
        success: function (data) {
...
function verificarGraficoAdministrador(id){
	$.ajax({
        url: '/SDI-Spring2.1/sla/carregarGraficoSLAAdministrador',
        data:	{
        	id: id
        },
        success: function (data) {
...
function verificarGraficoPorTecnico(){
	$.ajax({
        url: '/SDI-Spring2.1/sla/carregarGraficoSLAPorTecnico',
        success: function (data) {
        	if(data.perfil == 2){
        		carregarGrafico(data, "graficoTecnico");
