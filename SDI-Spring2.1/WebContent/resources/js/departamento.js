...
function deleteDepartamento(id){
	$.ajax({
        url: '/SDI-Spring2.1/departamento/delete',
        data: {
        	idDepto: id
        },
        success: function (data) {
...
function preencherFormAlterarDepartamento(id){
	$.ajax({
        url: '/SDI-Spring2.1/departamento/findByCodeJSON',
        data: {
        	idDepto: id
        },
        success: function (data) {
...
function createUpdateDepartamento(){
	...
	var url = '/SDI-Spring2.1/departamento/create';
	
	if(id != undefined && id != "") url = '/SDI-Spring2.1/departamento/update';
